...
from geneticAlgorithmsV2 import GeneticAlgoritm
...
def getFitness(robot, ORIGIN_POINT, DESTINATION_POINT):
    ...
    for phenotypeProgram in geneticAlgorithm.phenotypes:
        ...
        print(phenotypeProgram[0])
        print(len(phenotypeProgram[1]))
        for pointCoordinatesIndex in range (0, phenotypeProgram[0]):#phenotypeProgram[1]:
            ...
            viaPoint = Fanuc_2_Pose(phenotypeProgram[1][pointCoordinatesIndex])
